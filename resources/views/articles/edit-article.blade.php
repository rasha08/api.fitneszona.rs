                       ...
                       <form class="form-horizontal" role="form" method="POST" action="{{ url('/articles/'.$data['article']->id) }}">
                        <input name="_method" type="hidden" value="PUT">
                           ...
                           <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                               ...
                               <div class="col-md-11">
                                   <input id="title" type="text" class="form-control" name="title" value="{{ $data['article']->title }}">
                                   @if ($errors->has('title'))
                           ...
                           <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                               ...
                               <div class="col-md-10">
                                   <textarea id="description" class="form-control" name="description">{{ $data['article']->description }}</textarea>
                           ...
                           <div class="form-group{{ $errors->has('text') ? ' has-error' : '' }}">
                               ...
                               <div class="col-md-12">
                                   <textarea id="article-ckeditor" class="form-control" name="text">
                                     {{ $data['article']->text }}
                                   </textarea>
                                   @if ($errors->has('text'))
                                       <span class="help-block">
                           ...
                           <div class="form-group{{ $errors->has('image_url') ? ' has-error' : '' }}">
                               ...
                               <div class="col-md-7">
                                   <input id="image_url" type="text" class="form-control" name="image_url" value="{{ $data['article']->image_url }}">
                           ...
                           <div class="form-group{{ $errors->has('tags') ? ' has-error' : '' }}">
                               ...
                               <div class="col-md-7">
                                   <input id="tags" type="text" class="form-control" name="tags" value="{{ $data['article']->tags }}">
                                   @if ($errors->has('tags'))
                                       <span class="help-block">
                           ...
                           <div class="form-group{{ $errors->has('category') ? ' has-error' : '' }}">
                               ...
                               <div class="col-md-6">
                                   <select class="form-control" id="category" name="category">
                                       <option value={{$data['article']->category}}>{{$data['article']->category}}</option>
